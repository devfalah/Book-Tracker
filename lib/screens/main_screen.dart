...
import 'package:book/widgets/book_details_dialog.dart';
import 'package:book/widgets/book_search_page.dart';
import 'package:book/widgets/create_profile.dart';
        ...
        actions: [
          StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              final MUser curUser = snapshot.data!.docs.map((user) {
